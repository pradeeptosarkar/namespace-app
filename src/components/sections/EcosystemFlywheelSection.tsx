      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="lg:hidden">
          ...
          <div className="relative flex items-center justify-center mb-12">
            ...
            <div className={`relative w-40 h-40 my-8 transition-all duration-1000 delay-500 scale-50`}>
              ...
              <div className="absolute inset-6 rounded-full border border-primary/20 bg-background shadow-lg">
                ...
                {flywheelElements.map((element, index) => {
                  const positions = {
                    top: "-top-24 left-1/2 -translate-x-1/2 -translate-y-1/2",
                    right: "-right-36 top-1/2 translate-x-1/2 -translate-y-1/2", 
                    bottom: "-bottom-24 left-1/2 -translate-x-1/2 translate-y-1/2",
                    left: "-left-36 top-1/2 -translate-x-1/2 -translate-y-1/2"
                  };
                      ...
                      <div className="group relative">
                        ...
                        <div 
                          className={`relative cursor-pointer border rounded-xl text-center shadow-sm transition-all duration-500 ease-in-out ${
                            isExpanded 
                              ? 'w-[480px] h-[320px] border-primary/40 shadow-2xl z-50 bg-background/95 backdrop-blur-md' 
                              : 'w-48 h-28 border-primary/20 hover:border-primary/30 hover:shadow-md bg-card'
                          } ${
                            isExpanded ? 'p-8' : 'p-4'
                          }`}
                          onClick={() => {
        ...
        {/* Desktop Layout - 1:4 Split */}
        <div className="hidden lg:pt-24 lg:pb-4 lg:flex lg:gap-12 lg:items-center">
          {/* Left Side - 1 part (Title and Subtitle) */}
          ...
          {/* Right Side - 4 parts (Flywheel + Description) */}
          <div className="lg:w-3/4 flex flex-col items-center">
            {/* Flywheel Visualization */}
            <div className="relative flex items-center justify-center mb-12">

              {/* Redesigned Central Flywheel */}
              <div className={`relative w-60 h-60 my-8 transition-all duration-1000 delay-500 scale-90`}>
                      ...
                      >
                        <div className="group relative">
                          ...
                          <div 
                            className={`relative cursor-pointer border rounded-xl text-center shadow-sm transition-all duration-500 ease-in-out ${
                              isExpanded 
                                ? 'w-[600px] h-[400px] border-primary/40 shadow-2xl z-50 bg-background/95 backdrop-blur-md' 
                                : 'w-60 h-24 border-primary/20 hover:border-primary/30 hover:shadow-md bg-card'
                            } ${
                              isExpanded ? 'p-8' : 'p-4'
                            }`}
                            onMouseEnter={() => {
                          ...
                          >
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-center">
                              <h3 className={`font-bold text-foreground group-hover:text-primary transition-all duration-300 ${
                                isExpanded ? 'text-3xl mb-6' : 'text-2xl mb-2'
                              }`}>
                                {element.title}
                              </h3>
                              ...
                              <div className={`transition-all duration-500 overflow-hidden ${
                                ...
                                {isExpanded && (
                                  <div className="mt-6 space-y-4">
                                    <div className="text-base text-muted-foreground opacity-75">
                                      {element.position === 'top' && "Discover new opportunities, connect with like-minded individuals, and showcase your skills through various engaging activities."}
                                      {element.position === 'right' && "Build valuable connections, develop expertise, and unlock career opportunities in our thriving community."}
                                      {element.position === 'bottom' && "Comprehensive programs designed to bridge the gap between learning and real-world application."}
                                      {element.position === 'left' && "Partner with us to discover talent, validate ideas, and contribute to the next generation of innovators."}
        ...
        {/* Anchor Statement - Separate Centered Section */}
        <div className={`text-center mt-4 transition-all duration-1000 delay-1000 ${
          hasIntersected 
            ? 'opacity-100 translate-y-0' 
            : 'opacity-0 translate-y-10'
        }`}>
