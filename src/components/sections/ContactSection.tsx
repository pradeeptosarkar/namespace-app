  ...
  const ctaSections = [
    {
      ...
      action: {
        ...
        platforms: [
          ...
          { name: "WhatsApp", icon: <WhatsAppIcon className="w-5 h-5" />, url: "https://www.whatsapp.com/channel/0029VabtgrVKLaHjzSXEL52f", stats: "1K+ subscribers" },
    ...
    },
    {
      ...
      action: {
        ...
        platforms: [
          ...
          { name: "Telegram", icon: <TelegramIcon className="w-5 h-5" />, url: "https://t.me/+11ngnAGsGYg4YTE1", stats: "500+ members" }
        ]
      }
    },
    {
