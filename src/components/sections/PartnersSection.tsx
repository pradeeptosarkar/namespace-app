...
const PartnersSection = () => {
  ...
  return (
    <section id="partners" ref={ref} className="scroll-section bg-namespace-white text-namespace-black relative overflow-hidden section-transition">
      {/* Geometric patterns */}
          ...
          <div className="text-center">
            <Dialog>
              <DialogTrigger asChild>
                <Button 
                  size="lg" 
                  className="bg-gradient-purple hover:bg-gradient-purple/90 text-white font-sora font-semibold px-8 py-4 text-lg rounded-xl shadow-elegant hover:shadow-glow transition-all duration-300 magnetic-element"
                >
                  Partner with us
                </Button>
              </DialogTrigger>
