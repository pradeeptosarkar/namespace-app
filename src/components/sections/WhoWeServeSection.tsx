...
const WhoWeServeSection = () => {
  const audiences = [
    ...
    },
    {
      ...
      title: "Institutions",
      description: "Educational institutions seeking to modernize and connect with the tech world",
      color: "from-green-500 to-green-600"
    },
    {
      icon: <Users className="w-12 h-12" />,
      title: "Companies",
      description: "Forward-thinking organizations building and scaling with tech talent",
